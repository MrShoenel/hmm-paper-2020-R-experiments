...
for (idx in 1:1) {
  ...
  # Yes, we redid the RFE.. anyhow, let's select all variables
  # that we want:
  useVars <- predictors(rfe)
  plot(rfe, type = c("g", "o"))
  ...
  condDens_B_1stOrder(states = states, data=data[1:199,], observations = data[200:236,], stateColumn = "label_t_0")
}
```
